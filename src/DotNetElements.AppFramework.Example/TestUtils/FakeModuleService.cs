	...
	where TModuleService : ModuleService<TDbContext>
{
	...
	public static FakeModuleService<TDbContext, TModuleService> Create(TDbContext dbContext, ICurrentUserProvider currentUserProvider, TimeProvider timeProvider, string? logContext)
	{
		return new FakeModuleService<TDbContext, TModuleService>(dbContext, currentUserProvider, timeProvider, logContext);
	}

	private readonly TDbContext dbContext;

	private FakeModuleService(TDbContext dbContext, ICurrentUserProvider currentUserProvider, TimeProvider timeProvider, string? logContext)
	{
