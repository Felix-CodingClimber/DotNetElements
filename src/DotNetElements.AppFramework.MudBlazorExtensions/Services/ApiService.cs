...
public class ApiService
{
    ...
    {
        ApiResult<List<TModel>> result = await GetAsync<List<TModel>>(url, noMessage, cancellationToken: cancellationToken);
    ...
    public async Task<ApiResult<T>> GetAsync<T>(string url, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ApiResult<TReturn>> PostAsync<TReturn>(string url, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        HttpResponseMessage response = await httpClient.PostAsync(url, null, cancellationToken);
        ...
        TReturn? content = await response.Content.ReadFromJsonAsync<TReturn>(jsonOptions, cancellationToken);
    ...
    public async Task<ApiResult> PostAsync<T>(string url, T content, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        HttpResponseMessage response = await httpClient.PostAsJsonAsync(url, content, jsonOptions, cancellationToken);
    ...
    public async Task<ApiResult<TReturn>> PostAsync<T, TReturn>(string url, T content, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        ...
        TReturn? returnContent = await response.Content.ReadFromJsonAsync<TReturn>(jsonOptions, cancellationToken);
    ...
    public async Task<ApiResult<TReturn>> PutAsync<TReturn>(string url, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        HttpResponseMessage response = await httpClient.PutAsync(url, null, cancellationToken);
    ...
    public async Task<ApiResult> PutAsync<T>(string url, T content, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        HttpResponseMessage response = await httpClient.PutAsJsonAsync(url, content, jsonOptions, cancellationToken);
    ...
    public async Task<ApiResult<TReturn>> PutAsync<T, TReturn>(string url, T content, string? messageOnSuccess = null, string? messageOnFail = null, bool noMessage = false, JsonSerializerOptions? jsonOptions = null, CancellationToken cancellationToken = default)
    {
        HttpResponseMessage response = await httpClient.PutAsJsonAsync(url, content, jsonOptions, cancellationToken);
