    ...
    where TDbContext : DbContext, IFakeDbContext
{
    ...
    private DbContextOptions CreateOptions()
    {
        ...
        return new DbContextOptionsBuilder()
            ...
            .AddInterceptors(
                new TestAuditInterceptor(TimeProvider, UserProvider))
            .Options;
    }
        ...
        where TModuleService : ModuleService<TDbContext>
    {
        ...
        return FakeModuleService<TDbContext, TModuleService>.Create(dbContext, UserProvider, TimeProvider, logContext);
    }
